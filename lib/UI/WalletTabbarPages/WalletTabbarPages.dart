...
import 'package:linedup_app/Components/TooltipContents/reservationFiltersContent.dart';
...
class _WalletTabBarPageState extends State<WalletTabBarPage> {
  List<String>? weekDayLabels = ["Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<AllReservationProvider>(builder: (context, reservationProvider, _) {
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SvgPicture.asset(
                          AssetConstants.locationOutLineIcon,
                          height: 22.sp,
                        ),
                      ],
                    ),
                                ...
                                var results = await showCalendarDatePicker2Dialog(
                                  ...
                                  config: CalendarDatePicker2WithActionButtonsConfig(
                                      ...
                                      disabledDayTextStyle:
                                          StaticTextStyle().regular.copyWith(fontSize: 12.sp, color: ColorConstants.blackColor),
                                      lastMonthIcon: Icon(
                                        Icons.arrow_back_ios,
                                        size: 15.sp,
                                      ),
                                      ...
                                      dayTextStyle:
                                          StaticTextStyle().regular.copyWith(fontSize: 12.sp, color: ColorConstants.blackColor),
                                      weekdayLabelTextStyle: StaticTextStyle().regular.copyWith(color: ColorConstants.blackColor),
                                ...
                                onTap: () {
                                  if (myReservations.type == "Reservation") {
                                    Navigator.of(context)
                                        .pushNamed(RouteConstants.reservationDetailPage, arguments: myReservations.id);
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          gradient: LinearGradient(
                                              ...
                                              colors: myReservations.type == "Reservation"
                                                  ? ColorConstants.simpleReservationGradient
                                                  : myReservations.type == "Event Ticket"
                                          ...
                                          Align(
                                            ...
                                            child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  border: Border.all(
                                                    color: myReservations.type == "Event Ticket" ||
                                                            myReservations.type == "Reservation"
                                                        ? ColorConstants.appPrimaryColor
                                                        : ColorConstants.whiteColor,
                                                  ),
                                                  color: myReservations.type == "Reservation"
                                                      ? ColorConstants.whiteColor
                                                      : ColorConstants.whiteColor.withOpacity(0.0.sp),
                                                ),
                                                child: Text(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        SvgPicture.asset(
                                                          AssetConstants.calendarOutline,
                                                          color: myReservations.type == "Event Ticket" ||
                                                                  myReservations.type == "Reservation"
                                                              ? ColorConstants.blackColor
                                                              : ColorConstants.whiteColor,
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        ...
                                        style:
                                            StaticTextStyle().regular.copyWith(fontSize: 10.sp, color: ColorConstants.blackColor),
                                      ),
                                    ),
                                  ],
                                ),

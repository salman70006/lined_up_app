...
import 'package:linedup_app/Controllers/AllUsersService/AllUsersService.dart';
import 'package:linedup_app/Controllers/TransferTicketService/TransferTicketService.dart';
    ...
    return Scaffold(
      ...
      body: Consumer<AllUsersProvider>(
        builder: (context, allUsersProvider,_) {
          ...
          return allUsers!.data!.isEmpty?Center(child: CircularProgressIndicator(
            color: ColorConstants.appPrimaryColor,
          ),) :Padding(
